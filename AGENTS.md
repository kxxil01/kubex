...
- Helm navigation now surfaces separate Releases and Repositories entries; releases reuse the existing list while repositories display a placeholder until wiring lands.
